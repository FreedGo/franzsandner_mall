...
$r=$empire->fetch1("select * from phome_enewsshopdd where ddno=$out_trade_no");
	
	//判断该笔订单是否在商户网站中已经做过处理			

	if($r[shoptype]!="2"){
$empire->query("UPDATE phome_enewsshopdd SET shoptype = '1' WHERE ddno =$out_trade_no LIMIT 1");
